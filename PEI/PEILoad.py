...
with open('./PEI/output/island_wind.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)

with open('./PEI/output/islandfossil.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)

with open('./PEI/output/windlocal.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)

with open('./PEI/output/windeport.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)

with open('./PEI/output/percentagewind.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)

with open('./PEI/output/cablesimport.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    field = ["STRUCTURE","STRUCTURE_ID","ACTION","FREQ","REF_AREA","COUNTERPART_AREA","ENERGY_FLOWS","DATETIME_LOCAL","OBS_VALUE","TIME_PERIOD","DAYLIGHT_OFFSET","DATETIME_LOCAL_OFFSET","UNIT_MEASURE","UNIT_MULT","MEASURE_TYPE","OBS_STATUS","CONF_STATUS"]
    writer.writerow(field)
